...
const {
  ...
  getCategoriesSchema,
} = require('../schemas/categories.schema'); // importamos el schema de validacion
// -----------------------------------------------
// servicios de la api
const CategorieService = require('../services/categories.service'); // importamos el servicio de categorias
// creamos una instancia del servicio de categorias-----------------
...
router.get(
  '/:id',
  validatorHandler(getCategoriesSchema, 'params'), // validamos los datos de entrada
  async (req, res, next) => {
...
router.post(
  '/',
  validatorHandler(createCategoriesSchema, 'body'), // validamos los datos de entrada
  async (req, res) => {
    const body = req.body;
    // ingresar categoria
...
router.patch('/:id',
  validatorHandler(getCategoriesSchema, 'params'), // validamos los datos de entrada
  validatorHandler(updateCategoriesSchema, 'body'), // validamos los datos de entrada
  async(req, res, next) => {
  try{
